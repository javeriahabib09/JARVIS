"""This code is executed to run JARVIS movie recommendation system."""
...
from jmrs.controller.controller_bot import ControllerBot
from jmrs.controller.controller_terminal import ControllerTerminal
...
if __name__ == '__main__':
    # Usage: python jarvis.py -c <path_to_config.yaml>
    # Version: Python 3.6
