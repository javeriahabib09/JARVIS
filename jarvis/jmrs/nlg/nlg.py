...
from jmrs.dialogue_manager.dialogue_state import DialogueState
...
from jmrs.dialogue_manager.slots import Slots
from jmrs.dialogue_manager.values import Values
    ...
    def generate_output(self, agent_dacts, dialogue_state=None, user_fname=None):
        ...
        for agent_dact in agent_dacts:
            if agent_dact.intent == AgentIntents.WELCOME:
                ...
                if isBot:
                    if new_user:
                        intent_response += f'Hi {user_fname}. Welcome to Jarvis. '
                    else:
